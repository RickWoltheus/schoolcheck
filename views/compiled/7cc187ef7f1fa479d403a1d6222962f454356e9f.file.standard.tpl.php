...
<?php if ($_valid && !is_callable('content_5810dc7ea09ac1_29343658')) {function content_5810dc7ea09ac1_29343658($_smarty_tpl) {?><form class="cms_form" action="" method="post">
 <h2>standard settings</h2>
  ...
  <input type="text" name="blog_title" value="" placeholder="blog_title"><br>
